...
class tpu_detector:
    ...
    def __init__(self, model, labels, threshold=0.5, device_path=None):
        ...
        self.image_sub = rospy.Subscriber("/raspicam_node/image/raw", Image, self.callback)
...
def main(args):
    ...
    model_path = rospy.get_param('~model_path', default='/data/robot/tpu_models/mobilenet_ssd_v1_coco_quant_postprocess_edgetpu.tflite')
    label_path = rospy.get_param('~label_path', default='/data/robot/tpu_models/coco_labels.txt')
